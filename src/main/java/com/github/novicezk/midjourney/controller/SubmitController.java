...
public class SubmitController {
    ...
    public SubmitResultVO change(@RequestBody SubmitChangeDTO changeDTO) {
        ...
        if (!Set.of(TaskAction.UPSCALE, TaskAction.VARIATION, TaskAction.ZOOM, TaskAction.REROLL).contains(changeDTO.getAction())) {
        ...
        if (!Set.of(TaskAction.IMAGINE, TaskAction.VARIATION, TaskAction.UPSCALE, TaskAction.ZOOM, TaskAction.BLEND).contains(targetTask.getAction())) {
